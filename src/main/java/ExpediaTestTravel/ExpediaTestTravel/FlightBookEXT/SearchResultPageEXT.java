package ExpediaTestTravel.ExpediaTestTravel.FlightBookEXT;
...
public class SearchResultPageEXT extends SearchResultPage {
	...
	public void clickDeclineHotelBookingLink() {
		if (getDeclineHotelBookingLink().isElementPresent()) {
			getDeclineHotelBookingLink().clickAndExpect(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#xSellHotelForcedChoice-title")));
		}
	}
